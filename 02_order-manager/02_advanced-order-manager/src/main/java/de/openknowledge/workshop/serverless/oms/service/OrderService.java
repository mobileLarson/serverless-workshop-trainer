...
public class OrderService {
    ...
    // private static final OrderRepositoryType ORDER_REPOSITORY_TYPE = OrderRepositoryType.DYNAMODB;
    private static final OrderRepositoryType ORDER_REPOSITORY_TYPE = OrderRepositoryType.DYNAMODB_ENHANCED;
    private static final OrderRepository repository = OrderRepositoryFactory.getOrderRepository(ORDER_REPOSITORY_TYPE);
