...
import static de.openknowledge.workshop.serverless.util.LambdaEnvironment.getEnvVarAsString;
...
public class AwsRegionProvider {
    ...
    public static Region getDefaultRegion() {
        String region = getEnvVarAsString(ENV_VAR_REGION, DEFAULT_REGION.toString());
